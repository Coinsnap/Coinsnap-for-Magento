...
//  Get the current API Key information
    ...
    public function getCurrent(): \Coinsnap\Payment\Api\Result\ApiKey
    {
        ...
        if ($response->getStatus() === 200) {
            return new \Coinsnap\Payment\Api\Result\ApiKey(json_decode($response->getBody(), true, 512, JSON_THROW_ON_ERROR));
        } else {
